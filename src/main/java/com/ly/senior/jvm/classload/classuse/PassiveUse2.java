...
/**
 * @author luoyong
 *  * @create 2021-05-05 12:55 下午
 *  * @last modify by [luoyong 2021-05-05 12:55 下午]
 * @Description: 3. 引用常量不会触发此类或接口的初始化。因为常量在链接阶段就已经被显式赋值了。
...
//        System.out.println(SerialA.ID1);
    ...
    public void test3() {
        try {
            Class clazz = ClassLoader.getSystemClassLoader().loadClass("com.ly.senior.jvm.classload.classuse.Order");
